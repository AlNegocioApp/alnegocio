...
import { HAS_BACKEND, TRIAL_DAYS } from "./config";
    ...
    tenants: [
      {
        ...
        requests: [],
        invoices: [{ id: "INV1", date: todayISO(), months: 1, amount: 1200, method: "transferencia" }],
      },
      {
        id: "demo-2",
        password: "1234",
...
export function PlatformProvider({ children }: { children: ReactNode }) {
    ...
    if (HAS_BACKEND && supabase) {
      ...
      return {
        ...
        tenant: {
          ...
          email: profile.email,
          phone: profile.phone ?? "",
          plan_id: (profile.plan_id ?? "estandar") as Tenant["plan_id"],
  ...
  const createRequest = useCallback(
    async (i: RequestInput) => {
      ...
      const amount = 0; // el monto se acuerda por WhatsApp en el nuevo modelo
