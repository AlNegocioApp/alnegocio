...
const PERMISSIONS: Record<Role, ModuleKey[]> = {
  ...
  admin: ["dashboard", "ventas", "productos", "insumos", "elaborados", "compras", "contactos", "empleados", "reportes", "cuadre", "cambio", "calculadora"],
  vendedor: ["ventas", "cuadre", "cambio", "calculadora"],
};
